...
s_data.BL_airfoil_ratio = json_data["BL_airfoil_ratio"];
s_data.BL_airfoil_size = json_data["BL_airfoil_size"];
s_data.BL_airfoil_thickness=json_data["BL_airfoil_thickness"];
s_data.BL_emitter_ratio = json_data["BL_emitter_ratio"];
s_data.BL_emitter_size = json_data["BL_emitter_size"];
s_data.BL_emitter_thickness=json_data["BL_emitter_thickness"];
...
Build_Geometry my_geometry(s_data,cutted_points);
...
my_geometry.write_BL_airfoil(outFile);
my_geometry.write_BL_emitter(outFile);
