...
coarse = 4.e-4;
very_coarse = 6e-4;
extremely_coarse = 2e-3;

// Wire emitter points
Point(3) = {0,0,0,fine};
Point(27) = {-radius, 0, 0};
Point(2) = {-radius,radius,0,fine};
Point(26) = {radius-emitter_length,radius,0,fine};
Point(28) = {radius-emitter_length,0,0};
Point(1) = {-emitter_length,0,0,fine};
...
Point(23) = {shift,shift+radius,0,fine};
Point(24) = {-emitter_length-shift,shift+radius,0,fine};
Point(25) = {-emitter_length-shift,0,0,fine};
...
Curve Loop(3) = {-101,-100,-1,15:19}; // Emitter loop,
...
// Set boundary ids
Physical Curve(1) = {1,100,101}; // Emitter,
