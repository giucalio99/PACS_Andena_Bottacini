...
namespace Step40
{
  ...
  //   Locally Owned DoFs: These are the degrees of freedom that are owned exclusively 
  //   by a particular processor in a parallel computing setup.

  //   Locally Relevant DoFs: include both the degrees of freedom associated with elements 
  //   entirely contained within the processor's domain, as well as some degrees of freedom 
  //   associated with elements that are adjacent to its domain
  ...
  // other about degrees of freedom on ghost cell. The result is a DoFHandler     NB
