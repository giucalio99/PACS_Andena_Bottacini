#ifndef "NS_PRECONDITIONER_AND_BOUNDARIES_VALUES"
#define "NS_PRECONDITIONER_AND_BOUNDARIES_VALUES"

using namespace dealii;
using namespace std;

// ############################# NS preconditioner class ###############################################################################
...
template <int dim>
double BoundaryValues<dim>::value(const Point<dim> & /*p*/,    // fatto da menessini ????
...
#endif "NS_PRECONDITIONER_AND_BOUNDARIES_VALUES"